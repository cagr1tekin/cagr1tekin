...
">
  ...
  <img src="https://i.scdn.co/image/ab67616d0000b273bb6112b17e4ef55121948cd5" width="320" style="border-radius: 15px; margin-bottom: 20px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.5);">

  <div style="font-size: 22px; font-weight: bold; margin-bottom: 10px;">Karar Vermek Zor</div>
  <div style="font-size: 16px; color: #B3B3B3; margin-bottom: 20px;">Ahmet Kaya</div>

  <a href="https://open.spotify.com/track/5d5R9os5b1yQhpSDnuocxR" target="_blank" style="
